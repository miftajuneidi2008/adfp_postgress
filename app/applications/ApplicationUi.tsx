...
import { getCurrentUser, SessionPayload } from "@/lib/auth/hooks"
...
export default function ApplicationUi({application,profile}:{application:any,profile:SessionPayload | null}) {
     const { user } = useAuthContext()
     const router = useRouter()

  const [applications, setApplications] = useState<Application[]>(application)
