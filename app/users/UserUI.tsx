...
interface UserUIProps {
  activeUsers: User[]; // <--- CHANGE THIS LINE from User to User[]
  branch: Branch[]; // Assuming you have a Branch interface
}

export default function UserUI({ activeUsers, branch }: UserUIProps) {
