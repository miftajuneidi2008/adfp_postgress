...
export default function SettingUI({approver, district, branch, product, assignment}:{approver:ApproverUser[],district:District[], branch:Branch[], product:Product[], assignment:ApproverAssignment[]}) {
  ...
  const [approvers, setApprovers] = useState<ApproverUser[]>(approver ||[])
  const [districts, setDistricts] = useState<District[]>(district ||[])
  const [branches, setBranches] = useState<Branch[]>(branch ||[])
  const [products, setProducts] = useState<Product[]>(product|| [])
  const [assignments, setAssignments] = useState<ApproverAssignment[]>(assignment|| [])
                ...
                <div className="overflow-x-auto">
                  <table className="w-full">
                    ...
                    <tbody className="divide-y">
                      {Object.values(groupedAssignments).map(({ approver, assignments },index) => {
